...
report_content = """# trAck Codebase Deep Architecture Audit & Handoff Report
...
with open(r"d:\Projects\Track\codebase_architecture_report.md", "w", encoding="utf-8") as f:
    f.write(report_content)

print("Successfully wrote codebase_architecture_report.md")
